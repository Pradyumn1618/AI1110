...
\hhline{|----------|}
	...
	\gnumericColE+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{\{0,1,2....\}}}
	&\multicolumn{5}{p{	\gnumericColF+%
	\gnumericColG+%
	\gnumericColH+%
	\gnumericColI+%
	\gnumericColJ+%
	\tabcolsep*2*4}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Number of tosses}}
\\
\hhline{|----------|}
	 \multicolumn{2}{|p{	\gnumericColA+%
	\gnumericColB+%
	...
	\gnumericColE+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{\{-1.5$n$,2.5-1.5$n$,..$n$\}}}
	&\multicolumn{5}{p{	\gnumericColF+%
	\gnumericColG+%
	\gnumericColH+%
	\gnumericColI+%
...
\hhline{|----------|}
	...
	\gnumericColE+%
	\tabcolsep*2*2}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{\{$0,1,2,...n$\}}}
	&\multicolumn{5}{p{	\gnumericColF+%
	\gnumericColG+%
	\gnumericColH+%
	\gnumericColI+%
	\gnumericColJ+%
	\tabcolsep*2*4}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Number of heads after n tosses}}
\\
\hhline{|--|---|-----|}
\end{tabular}
