...
\end{align}
Let $A$ be a random variable denoting the amount money a person can have.
\begin{align}
\therefore \text{by question}\\ 
A&=X-\brak{4-X}\times 1.5\\
\implies A&=2.5\times X - 6 \label{eq:2} 
\end{align}
...
\begin{align}
\pr{X=i}&=\pr{A=2.5i-6}=\comb{n}{i}\brak{\frac{1}{2}}^n \label{eq:3}
\end{align}
$$
\therefore\\
p_A\brak{2.5k-6}=
\begin{cases}
\comb{n}{k}\brak{\frac{1}{2}}^n,&\forall\,\,0\le k \le n+1\\
0,&\text{otherwise}
\end{cases}
$$
For $n=4$ by \eqref{eq:3}
\begin{align}
